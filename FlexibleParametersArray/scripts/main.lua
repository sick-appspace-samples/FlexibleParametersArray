...
---Writes to a specified array at a specified index, expanding it if needed - will throw errors if something's wrong with the values or indices.
---@param arrayName string name of the array to add the values to
---@param index int index to add the value
---@param value? any optional - value to write in the array. By default, appends to the end of array
...
---Deletes an element from a specified index in an array, moving elements behind deleted one forward. Returns deleted item, or nil if the array was already empty. Will throw errors if indices don't match.
---@param arrayName string name of the array to add the values to
---@param index int index to delete the value from (default: 0)
---@return any p element that was just deleted from the array
...
---Reads an element from a specified index in an array, and returns it or nil if array was empty. Will throw errors if indices don't match.
---@param arrayName string name of the array to add the values to
---@param index int index to read the value from (default: last index)
---@return any ret value of the element that was just read from the array
